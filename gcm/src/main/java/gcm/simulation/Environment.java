...
public interface Environment extends Element {
	 ...
	 *             <li>{@link SimulationErrorType#NULL_GROUP_TYPE_ID} the group
	 *             type id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_GROUP_TYPE_ID} if the
	 *             group type id is unknown
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoking component is not a global component, a region
	 ...
	 * compartment and assigned default person property values. Person
	 * identifier values are unique to the people in the simulation at any given
	 * time, but may be reused by the simulation at people are removed.
	 *
	 * @throws ModelException
	 *
	 ...
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoking component is not a global component
	 *
	 */
	 ...
	 *             <li>{@link SimulationErrorType#DUPLICATE_GROUP_MEMBERSHIP} if
	 ...
	 *
	 *
	 *             <li>{@link SimulationErrorType#NULL_PLAN} if the plan is null
	 *             <li>{@link SimulationErrorType#PAST_PLANNING_TIME} if the
	 *             plan time is in the past
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoking component is not a global component, a region
	 ...
	 *             <li>{@link SimulationErrorType#PAST_PLANNING_TIME} if the
	 *             plan time is in the past
	 *             <li>{@link SimulationErrorType#NULL_PLAN_KEY} if the key is
	 *             null
	 *             <li>{@link SimulationErrorType#DUPLICATE_PLAN_KEY} if the key
	 ...
	 * components may access the index if they know its key. The resulting
	 * indexed population is actively maintained by the GCM and is accessed by
	 * the key provided. This index is owned by the component that created it in
	 * that only that component may remove it from the Environment. However, all
	 * components have access to the index via its key.
	 *
	 ...
	 * @throws ModelException
	 *             *
	 *             <li>{@link SimulationErrorType#NULL_FILTER} if the filter is
	 *             null
	 *             <li>{@link SimulationErrorType#NULL_POPULATION_INDEX_KEY} if
	 *             the key is null
	 *             <li>{@link SimulationErrorType#DUPLICATE_INDEXED_POPULATION}
	 *             if the key corresponds to an existing population index
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             this method is invoked while the simulation has no active
	 *             component
	 *
	 */
	 ...
	 *             <li>{@link SimulationErrorType#NEGATIVE_RESOURCE_AMOUNT} if
	 ...
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoking component is not a global component or region
	 *
	 */
	 ...
	 *
	 *
	 *             <li>{@link SimulationErrorType#NULL_STAGE_ID} if stage id is
	 *             null
	 *             <li>{@link SimulationErrorType#UNKNOWN_STAGE_ID} if stage id
	 *             is unknown
	 *             <li>{@link SimulationErrorType#OFFERED_STAGE_UNALTERABLE} if
	 *             stage is in the offered state
	 *             <li>{@link SimulationErrorType#NULL_MATERIAL_ID} if material
	 *             id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_MATERIAL_ID} if
	 *             material is unknown
	 *             <li>{@link SimulationErrorType#NEGATIVE_MATERIAL_AMOUNT} if
	 *             the amount is negative
	 *             <li>{@link SimulationErrorType#NON_FINITE_MATERIAL_AMOUNT} if
	 ...
	 *             <li>{@link SimulationErrorType#OFFERED_STAGE_UNALTERABLE} if
	 *             stage is in the offered state
	 *             <li>{@link SimulationErrorType#NULL_RESOURCE_ID} if resource
	 *             id is null
	 ...
	 *             id is unknown for the materials producer
	 *             <li>{@link SimulationErrorType#OFFERED_STAGE_UNALTERABLE} if
	 *             the batch is part of an offered stage
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             invoker is not the owning materials producer component
	 *
	 *
	 ...
	 * @throws ModelException
	 *
	 *             <li>{@link SimulationErrorType#NULL_BATCH_ID} if the batchId
	 *             id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_BATCH_ID} if the
	 *             batchId id is unknown
	 *
	 */
	 ...
	 *             the batchPropertyId id unknown
	 */
	...
	/**
	 * Returns a contacted person from the group specified by the groupId by
	 * using the supplied BiWeightingFunction from the sourcePersonId against
	 * all members of the group. The sourcePersonId can be excluded as a return
	 * value. Optional result will reflect when no contact was possible.
	 * 
	 * Note that the BiWeightingFunction must be stable: Repeated invocations of
	 * the function with any fixed set of arguments must result in a single
	 * return value during the scope of this method.
	 *
	 * @throws ModelException
	 *             <li>{@link SimulationErrorType#NULL_GROUP_ID} if the group id
	 *             is null
	 ...
	 *             <li>{@link SimulationErrorType#UNKNOWN_PERSON_ID} if the
	 *             person id is unknown
	 *             <li>{@link SimulationErrorType#NULL_WEIGHTING_FUNCTION} if
	 *             the biWeightingFunction is null
	 *             <li>{@link SimulationErrorType#MALFORMED_WEIGHTING_FUNCTION}
	 *             if the biWeightingFunction is malformed. (some evaluate to
	 *             negative numbers,NaN, infinity, etc. -- note that if all
	 *             weights are zero then the optional will return isPresent() of
	 *             false)
	 * 
	 */
	 ...
	 * using the supplied BiWeightingFunction from the sourcePersonId against
	 * all members of the group. The sourcePersonId can be excluded as a return
	 * value. Optional result will reflect when no contact was possible. Uses
	 * the random generator associated with the RandomNumberGeneratorId.
	 * 
	 * Note that the BiWeightingFunction must be stable: Repeated invocations of
	 * the function with any fixed set of arguments must result in a single
	 * return value during the scope of this method.
	 ...
	 *             the property id does not correspond to a known global
	 *             property identifier
	 */
	 ...
	 *             the groupPropertyId id unknown
	 */
	 ...
	 *
	 * @throws ModelException
	 *             <li>{@link SimulationErrorType#NULL_GROUP_ID} if the groupId
	 *             id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_GROUP_ID} if the
	 *             groupId id is unknown
	 */
	...
	/**
	 * Returns a list of person identifiers associated with the indexed
	 * population.
	 *
	 *
	 * @throws ModelException
	 ...
	 *             the materialsProducer id is null
	...
	/**
	 * Returns a contacted person from the group specified by the groupId by
	 * using the supplied MonoWeightingFunction against all members of the
	 * group. Optional result will reflect when no contact was possible.
	 *
	 * Note that the MonoWeightingFunction must be stable: Repeated invocations
	 * of the function with any fixed set of arguments must result in a single
	 * return value during the scope of this method.
	 *
	 * @throws ModelException
	 *             <li>{@link SimulationErrorType#NULL_GROUP_ID} if the group id
	 *             is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_GROUP_ID} if the group
	 *             id is unknown(group does not exist) *
	 *             <li>{@link SimulationErrorType#NULL_WEIGHTING_FUNCTION} if
	 *             the monoWeightingFunction is null
	 *             <li>{@link SimulationErrorType#MALFORMED_WEIGHTING_FUNCTION}
	 *             if the monoWeightingFunction is malformed. (some evaluate to
	 *             negative numbers, etc. -- note that if all weights are zero
	 *             then the optional will return isPresent() of false)
	 */
	 ...
	 * Note that the MonoWeightingFunction must be stable: Repeated invocations
	 * of the function with any fixed set of arguments must result in a single
	 * return value during the scope of this method. Uses the random generator
	 ...
	 * groupId. Optional result will reflect when no contact was possible.
	 *
	 * @throws ModelException
	 *             <li>{@link SimulationErrorType#NULL_GROUP_ID} if the group id
	 *             is null
	...
	/**
	 * Returns a randomly contacted person from the group specified by the
	 * groupId that will exclude the specified person. The excludedPersonId is
	 * not required to be a member of the group. Optional result will reflect
	 * when no contact was possible.
	 *
	 * @throws ModelException
	 *             <li>{@link SimulationErrorType#NULL_GROUP_ID} if the group id
	 *             is null
	...
	/**
	 * Returns a randomly contacted person from the group specified by the
	 * groupId. Optional result will reflect when no contact was possible. Uses
	 * the random generator associated with the given RandomNumberGeneratorId.
	 *
	 * @throws ModelException
	 *             <li>{@link SimulationErrorType#NULL_GROUP_ID} if the group id
	 *             is null
	 ...
	 * groupId that will exclude the specified person. The excludedPersonId is
	 * not required to be a member of the group. Optional result will reflect
	 * when no contact was possible. Uses the random generator associated with
	 * the given RandomNumberGeneratorId.
	 *
	 * @throws ModelException
	 *             <li>{@link SimulationErrorType#NULL_GROUP_ID} if the group id
	 *             is null
	 ...
	 * null
	 * <li>{@link SimulationErrorType#UNKNOWN_RESOURCE_ID} if the resource id is
	 * not known
	 */
	 ...
	 *             the property id does not correspond to a known person
	 *             property identifier
	 */
	 ...
	 *             the property id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_PERSON_PROPERTY_ID} if
	 *             the property id is not a person property
	 */
	 ...
	 *             if person region arrival times are not selected for tracking
	 *             in the scenario
	 * 
	 */
	 ...
	 *             <li>{@link SimulationErrorType#UNKNOWN_RANDOM_NUMBER_GENERATOR_ID}
	 *             if the randomNumberGeneratorId does not correspond to an
	 *             existing random Number Generator Id in the scenario
	 * 
	 */
	...
	/**
	 * Returns a randomly selected person identifier from an indexed population
	 * excluding the given person identifier if that parameter is not null.
	 * Returns null if the population index is empty or contains only the
	 * excluded person.
	 *
	 * @throws ModelException
	 *
	 ...
	 *             the property id does not correspond to a known region
	 *             property identifier
	 */
	 ...
	 * @throws ModelException
	 *
	 *             <li>{@link SimulationErrorType#NULL_STAGE_ID} if the stageId
	 *             id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_STAGE_ID} if the
	 *             stageId id is unknown
	 *
	 */
	 ...
	 *
	 *
	 *             <li>{@link SimulationErrorType#NULL_BATCH_ID} if batch id is
	 *             null
	 *             <li>{@link SimulationErrorType#UNKNOWN_BATCH_ID} if batch id
	 *             is unknown
	 *             <li>{@link SimulationErrorType#BATCH_NOT_STAGED} if batch id
	 *             is not associated with a stage
	 *             <li>{@link SimulationErrorType#OFFERED_STAGE_UNALTERABLE} if
	 *             batch's stage is in the offered state
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             invoker is not the owning materials producer component
	 *
	 */
	 ...
	 *             <li>{@link SimulationErrorType#UNKNOWN_BATCH_ID} if batch id
	 *             is unknown
	 *             <li>{@link SimulationErrorType#BATCH_ALREADY_STAGED} if batch
	 *             id is already associated with a stage
	 *             <li>{@link SimulationErrorType#NULL_STAGE_ID} if stage id is
	 *             null
	 *             <li>{@link SimulationErrorType#UNKNOWN_STAGE_ID} if stage id
	 *             is unknown
	 ...
	 *             if the batch and stage are owned by different materials
	 *             producers
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	...
	/**
	 * Starts or stops observation of people arriving in the given compartment
	...
	/**
	 * Starts or stops observation of people departing in the given compartment
	 * for the calling component.
	 *
	 * @throws ModelException
	 *
	...
	/**
	 * Starts or stops observation of compartment changes on the given person
	 * for the calling component.
	 *
	 * @throws ModelException
	 *             <li>{@link SimulationErrorType#NULL_PERSON_ID} if the person
	...
	/**
	 * Starts or stops observation of people arriving in the given region for
	 * the calling component.
	 *
	 * @throws ModelException
	 *
	...
	/**
	 * Starts or stops observation of people departing in the given region for
	 * the calling component.
	 *
	 * @throws ModelException
	 *
	...
	/**
	 * Starts or stops observation of property value changes for all regions
	 * for the calling component.
	 *
	 * @throws ModelException
	 *
	 ...
	 *
	 *             <li>{@link SimulationErrorType#NULL_MATERIALS_PRODUCER_ID} if
	 *             the source materials producer id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_MATERIALS_PRODUCER_ID}
	 ...
	 *
	 *             <li>{@link SimulationErrorType#NULL_MATERIALS_PRODUCER_ID} if
	 *             the destination materials producer id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_MATERIALS_PRODUCER_ID}
	...
	/**
	 * Returns true if and only if the a population index exists with the given
	 ...
	 *             personId is unknown
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoker is not the compartment containing the person
	 *
	 */
	 ...
	 *             group
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoking component is no either a global component, a
	 *             region or a compartment
	 */
	 ...
	 *
	 * Population indices are prepared and created in a multi-step process.
	 * First, filtering conditions are collected on behalf of the invoking
	 * component via the prepareXXX() methods. Then, the createPopulationIndex()
	 * is invoked to gather those filters and create a population index that is
	 * identified by keys supplied by the component. Once created, the filters
	 * for the index cannot be updated, but the simulation dynamically maintains
	 * the people associated with the index as conditions on the population
	 * change.
	 *
	 * Once the index is added via createPopulationIndex() the component may add
	 * a new set of filters via the prepareXXX() again.
	 *
	 * Only the component that creates an index may remove that index, but other
	 ...
	 *             <li>{@link SimulationErrorType#UNKNOWN_BATCH_ID} if batch id
	 *             is unknown
	 *             <li>{@link SimulationErrorType#NULL_BATCH_PROPERTY_ID} if
	 *             property id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_BATCH_PROPERTY_ID} if
	 *             property id is unknown
	 *             <li>{@link SimulationErrorType#NULL_BATCH_PROPERTY_VALUE} if
	 *             the value is null
	 *             <li>{@link SimulationErrorType#INCOMPATIBLE_VALUE} if the
	 *             value is incompatible with the defined type for the property
	 ...
	 *             property has been defined as immutable
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoker is not a global component of the given
	 *             compartment
	 *
	 */
	 ...
	 *             <li>{@link SimulationErrorType#UNKNOWN_GLOBAL_PROPERTY_ID} if
	 *             the property id is unknown
	 *             <li>{@link SimulationErrorType#NULL_GLOBAL_PROPERTY_VALUE} if
	 *             the value is null
	 *             <li>{@link SimulationErrorType#INCOMPATIBLE_VALUE} if the
	 *             value is incompatible with the defined type for the property
	 *             <li>{@link SimulationErrorType#IMMUTABLE_VALUE} if the
	 *             property has been defined as immutable
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoker is not a global component
	 *
	 */
	 ...
	 *             <li>{@link SimulationErrorType#UNKNOWN_GROUP_ID} if the group
	 *             id is unknown
	 *             <li>{@link SimulationErrorType#NULL_GROUP_PROPERTY_ID} if
	 *             property id is null
	 *             <li>{@link SimulationErrorType#NULL_GROUP_PROPERTY_ID} if
	 *             property id is unknown
	 *             <li>{@link SimulationErrorType#NULL_GROUP_PROPERTY_VALUE} if
	 *             the value is null
	 *             <li>{@link SimulationErrorType#INCOMPATIBLE_VALUE} if the
	 *             value is incompatible with the defined type for the property
	 *             <li>{@link SimulationErrorType#IMMUTABLE_VALUE} if the
	 *             property has been defined as immutable
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoker is not a global component, region component or
	 ...
	 *             property has been defined as immutable
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoker is not a global component or the given materials
	 *             producer
	 *
	 */
	 ...
	 *             <li>{@link SimulationErrorType#UNKNOWN_COMPARTMENT_ID} if the
	 *             compartment id is unknown
	 *             <li>{@link SimulationErrorType#SAME_COMPARTMENT} if the
	 *             compartment id is currently assigned to the person
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoker is not a global component or the person's current
	 *             compartment
	 *
	 */
	 ...
	 *             <li>{@link SimulationErrorType#UNKNOWN_PERSON_ID} if the
	 *             person id is unknown
	 *             <li>{@link SimulationErrorType#NULL_PERSON_PROPERTY_VALUE} if
	 *             the property id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_PERSON_PROPERTY_ID} if
	 *             the property id is unknown
	 *             <li>{@link SimulationErrorType#NULL_PERSON_PROPERTY_VALUE} if
	 ...
	 *             property has been defined as immutable
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoker is not a global component or the the person's
	 *             current region or the the person's current compartment
	 *
	 */
	 ...
	 *             <li>{@link SimulationErrorType#UNKNOWN_REGION_ID} if the
	 *             region id is unknown
	 *             <li>{@link SimulationErrorType#SAME_REGION} if the region is
	 *             the current region for the person
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoker is not a global component or the person's current
	 *             region
	 *
	 ...
	 *             <li>{@link SimulationErrorType#UNKNOWN_REGION_PROPERTY_ID} if
	 *             the property id is unknown
	 *             <li>{@link SimulationErrorType#NULL_REGION_PROPERTY_VALUE} if
	 *             the value is null
	 *             <li>{@link SimulationErrorType#INCOMPATIBLE_VALUE} if the
	 *             value is incompatible with the defined type for the property
	 *             <li>{@link SimulationErrorType#IMMUTABLE_VALUE} if the
	 *             property has been defined as immutable
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 *             the invoker is not a global component or the given region
	 *
	 */
	 ...
	 * @throws ModelException
	 *
	 *             <li>{@link SimulationErrorType#NULL_BATCH_ID} if the source
	 *             batch id is null
	 *             <li>{@link SimulationErrorType#NULL_BATCH_ID} if the
	 *             destination batch id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_BATCH_ID} if the
	 *             source batch id is unknown
	 *             <li>{@link SimulationErrorType#UNKNOWN_BATCH_ID} if the
	 *             destination batch id is unknown
	 *             <li>{@link SimulationErrorType#REFLEXIVE_BATCH_SHIFT} if the
	 *             source and destination batch ids are equal
	 *             <li>{@link SimulationErrorType#MATERIAL_TYPE_MISMATCH} if the
	 ...
	 *             <li>{@link SimulationErrorType#OFFERED_STAGE_UNALTERABLE} if
	 *             the source batch is part of an offered stage
	 *             <li>{@link SimulationErrorType#OFFERED_STAGE_UNALTERABLE} if
	 *             the destination batch is part of an offered stage
	 *             <li>{@link SimulationErrorType#NEGATIVE_MATERIAL_AMOUNT} if
	 *             the amount is negative
	 *             <li>{@link SimulationErrorType.NON_FINITE_MATERIAL_AMOUNT} if
	 *             the amount is not finite
	 ...
	 *             <li>{@link SimulationErrorType#REFLEXIVE_STAGE_TRANSFER} if
	 *             the material producer is the invoking materials producer
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 ...
	 * @throws ModelException
	 *
	 *             <li>{@link SimulationErrorType#NULL_REGION_ID} if the source
	 *             region id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_REGION_ID} if the
	 *             source region id is unknown
	 *             <li>{@link SimulationErrorType#NULL_REGION_ID} if the
	 *             destination region id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_REGION_ID} if the
	 *             destination region id is unknown
	 *             <li>{@link SimulationErrorType#REFLEXIVE_RESOURCE_TRANSFER}
	 *             if the source region id and the destination region are the
	 *             same
	 *             <li>{@link SimulationErrorType#NULL_RESOURCE_ID} if the
	 *             resource id is null
	 *             <li>{@link SimulationErrorType#UNKNOWN_RESOURCE_ID} if the
	 ...
	 *             <li>{@link SimulationErrorType#INSUFFICIENT_RESOURCES_AVAILABLE}
	 *             if the amount is in excess of the amount the source region
	 *             possesses
	 *             <li>{@link SimulationErrorType#COMPONENT_LACKS_PERMISSION} if
	 ...
	 * 
	 * @throws ModelException
	 *             <li>{@link SimulationErrorType#NULL_OUTPUT_ITEM} if the
	 *             output item is null
	 *             <li>{@link SimulationErrorType#INCORRECT_SCENARIO_ID_FOR_OUTPUT_ITEM}
	 *             if the output item does not have a scenario id that matches
	 *             the simulation that produces it.
	 ...
	 *             group type is unknown *
	 *             <li>{@link SimulationErrorType#NULL_GROUP_PROPERTY_ID} if the
	 *             group property id null
	 *             <li>{@link SimulationErrorType#UNKNOWN_GROUP_PROPERTY_ID} if
	 *             the group property id is unknown
	 * 
	 */
	 ...
	 * exception if invoked. Each interface that is implemented by the instance
	 * must be defined in top level classes and not as an internal part of
	 * another class.
	 */
	 ...
	 * 
	 * @throws ModelException
	 *             <li>{@link SimulationErrorType#NULL_GLOBAL_COMPONENT_ID} if
	 *             the component id is null
	 * 
	 */
