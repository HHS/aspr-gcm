...
public interface ObservableEnvironment extends Element {
	 ...
	 * @throws ModelException
	 *
	 *             <li>if the key is null
	 *             <li>if the person is null
	 *             <li>if the person is unknown
	 *             <li>if the key does not correspond to an existing population
	 *             index
	 *             <li>if the invoker is not the recognized by the simulation as
	 *             the current focal component
	 */
