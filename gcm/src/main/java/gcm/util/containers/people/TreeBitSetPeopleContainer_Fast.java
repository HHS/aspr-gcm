 ...
 * true for each person contained. Uses ~ 2-3 bits for each person in the ENTIRE
 * POPULATION OF THE SIMULATION.
 * 
 * @author Shawn Hatch
 */
@Source(status = TestStatus.REQUIRED, proxy = EnvironmentImpl.class)
public class TreeBitSetPeopleContainer_Fast implements PeopleContainer {
	...
	public TreeBitSetPeopleContainer_Fast(PersonIdManager personIdManager) {
	...
	public TreeBitSetPeopleContainer_Fast(PersonIdManager personIdManager, PeopleContainer peopleContainer) {
		this.personIdManager = personIdManager;
		// initialize the size of the bitSet to that of the full population,
		// including removed people
		int capacity = personIdManager.getPersonIdLimit();
