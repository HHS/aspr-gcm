...
import gcm.test.support.experimentspace.ExperimentTestSpace;
import gcm.test.support.experimentspace.ExperimentTestDimension.ExperimentTestDimensionBuilder;
import gcm.test.support.experimentspace.ExperimentTestSpace.ExperimentTestSpaceBuilder;
import gcm.test.support.experimentspace.ExperimentTestVariable.ExperimentTestVariableBuilder;
...
public class AT_ExperimentBuilder {
	...
	private static void refreshRandomGenerator(int seedCase) {
		RANDOM_GENERATOR = new Well44497b(SEED_PROVIDER.getSeedValue(seedCase));
	}
	...
	private static void revertRandomGenerator(long seed) {
		RANDOM_GENERATOR = new Well44497b(seed);
	}
	...
	private void fillWithVariantComparmentProperties(ExperimentTestSpaceBuilder experimentBuilder) {
		...
		experimentTestVariableBuilder.setValueExtractor(
				(scenario) -> scenario.getCompartmentPropertyValue(TestCompartmentId.COMPARTMENT_1, TestCompartmentId.COMPARTMENT_1.getCompartmentPropertyId(0)));
		experimentTestVariableBuilder.addValue("alpha");
		experimentTestVariableBuilder.addValue("beta");
		experimentBuilder.addExperimentVariable(experimentTestVariableBuilder.build());

		experimentTestVariableBuilder.setValueExtractor(
				(scenario) -> scenario.getCompartmentPropertyValue(TestCompartmentId.COMPARTMENT_1, TestCompartmentId.COMPARTMENT_1.getCompartmentPropertyId(1)));
		experimentTestVariableBuilder.addValue(1);
		experimentTestVariableBuilder.addValue(2);
		experimentTestVariableBuilder.addValue(3);
		experimentBuilder.addExperimentVariable(experimentTestVariableBuilder.build());
	...
	public void testAddBatch() {
		...
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_BATCH_ID);
		...
		experimentBuilder.addMaterial(materialId);
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_MATERIAL_ID);

		// precondition: if the material id is unknown
		fillWithVariantGlobalProperties(experimentBuilder);
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		experimentBuilder.addBatch(batchId, materialId, amount, materialsProducerId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_MATERIAL_ID);
		...
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NEGATIVE_MATERIAL_AMOUNT);
		...
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NON_FINITE_MATERIAL_AMOUNT);
		...
		experimentBuilder.addMaterial(materialId);
		experimentBuilder.addBatch(batchId, materialId, amount, materialsProducerId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_MATERIALS_PRODUCER_ID);
	...
	public void testAddBatchPropertyValue() {
		...
		experimentBuilder.addBatch(batchId, materialId, amount, materialsProducerId);
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_BATCH_ID);
		...
		fillWithVariantGlobalProperties(experimentBuilder);
		experimentBuilder.addBatchPropertyValue(batchId, TestMaterialId.getUnknownBatchPropertyId(), propertyValue);
		experimentBuilder.defineBatchProperty(materialId, batchPropertyId, propertyDefinition);
		experimentBuilder.addMaterial(materialId);
		experimentBuilder.addBatch(batchId, materialId, amount, materialsProducerId);
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_BATCH_PROPERTY_ID);
		...
		experimentBuilder.addBatch(batchId, materialId, amount, materialsProducerId);
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_BATCH_PROPERTY_VALUE);
		...
		experimentBuilder.addBatch(batchId, materialId, amount, materialsProducerId);
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.INCOMPATIBLE_VALUE);
		...
		experimentBuilder.addBatch(batchId, materialId, amount, materialsProducerId);
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.DUPLICATE_EXPERIMENT_DIMENSION_VALUE);
	...
	public void testAddBatchToStage() {
		...
		experimentBuilder.addMaterial(materialId);
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_STAGE_ID);
		...
		experimentBuilder.addMaterial(materialId);
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_STAGE_ID);
		...
		experimentBuilder.addMaterial(materialId);
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		experimentBuilder.addMaterialsProducerId(TestMaterialsProducerId.MATERIALS_PRODUCER_2, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.BATCH_STAGED_TO_DIFFERENT_OWNER);
		...
		experimentBuilder.addMaterial(materialId);
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.BATCH_ALREADY_STAGED);
	...
	public void testAddCompartmentId() {
		...
		fillWithVariantGlobalProperties(experimentBuilder);
		experimentBuilder.addCompartmentId(null, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_COMPONENT_IDENTIFIER);

		// precondition: if the compartment component class is null
		fillWithVariantGlobalProperties(experimentBuilder);
		experimentBuilder.addCompartmentId(compartmentId, null);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_COMPONENT_CLASS);
	...
	public void testAddCompartmentPropertyValue() {
		...
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_COMPARTMENT_PROPERTY_ID);
		...
		experimentBuilder.addCompartmentId(compartmentId, PlaceholderComponent.class);
		experimentBuilder.defineCompartmentProperty(compartmentId, compartmentPropertyId, propertyDefinition);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_COMPARTMENT_PROPERTY_ID);
		...
		experimentBuilder.addCompartmentId(compartmentId, PlaceholderComponent.class);
		experimentBuilder.defineCompartmentProperty(compartmentId, compartmentPropertyId, propertyDefinition);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_COMPARTMENT_ID);
		...
		experimentBuilder.addCompartmentId(compartmentId, PlaceholderComponent.class);
		experimentBuilder.defineCompartmentProperty(compartmentId, compartmentPropertyId, propertyDefinition);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_COMPARTMENT_ID);
		...
		experimentBuilder.addCompartmentId(compartmentId, PlaceholderComponent.class);
		experimentBuilder.defineCompartmentProperty(compartmentId, compartmentPropertyId, propertyDefinition);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_COMPARTMENT_PROPERTY_VALUE);
	...
	public void testAddGlobalComponentId() {
		...
		fillWithVariantGlobalProperties(experimentBuilder);
		experimentBuilder.addGlobalComponentId(null, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_COMPONENT_IDENTIFIER);
		...
		fillWithVariantGlobalProperties(experimentBuilder);
		experimentBuilder.addGlobalComponentId(globalComponentId, PlaceholderComponent.class);
		experimentBuilder.addGlobalComponentId(globalComponentId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.PREVIOUSLY_ASSIGNED_VALUE);
	...
	public void testAddGlobalPropertyValue() {
		...
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_GLOBAL_PROPERTY_ID);
		...
		experimentBuilder.defineGlobalProperty(globalPropertyId, propertyDefinition);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_GLOBAL_PROPERTY_ID);

		// precondition: if the value is null
		fillWithVariantCompartmentProperties(experimentBuilder);
		experimentBuilder.addGlobalPropertyValue(globalPropertyId, null);
		experimentBuilder.defineGlobalProperty(globalPropertyId, propertyDefinition);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_GLOBAL_PROPERTY_VALUE);
	...
	public void testAddGroup() {
		...
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_GROUP_ID);

		// precondition : if the group type id is null
		fillWithVariantGlobalProperties(experimentBuilder);
		experimentBuilder.addGroup(groupId, null);
		experimentBuilder.addGroupTypeId(groupTypeId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_GROUP_TYPE_ID);

		// precondition : if the group type id is unknown
		fillWithVariantGlobalProperties(experimentBuilder);
		experimentBuilder.addGroup(groupId, groupTypeId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_GROUP_TYPE_ID);
	...
	public void testAddGroupPropertyValue() {
		...
		GroupPropertyId groupPropertyId = TestGroupTypeId.GROUP_TYPE_5.getGroupPropertyIds()[0];
		...
		experimentBuilder.addGroup(groupId, groupTypeId);
		experimentBuilder.addGroupTypeId(groupTypeId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_GROUP_ID);
		...
		experimentBuilder.addGroup(groupId, groupTypeId);
		experimentBuilder.addGroupTypeId(groupTypeId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_GROUP_PROPERTY_ID);

		// precondition: if the group property is unknown
		experimentBuilder.addGroupPropertyValue(groupId, TestGroupTypeId.getUnknownGroupPropertyId(), propertyValue);
		experimentBuilder.defineGroupProperty(groupTypeId, groupPropertyId, propertyDefinition);
		experimentBuilder.addGroup(groupId, groupTypeId);
		experimentBuilder.addGroupTypeId(groupTypeId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_GROUP_PROPERTY_ID);
		...
		experimentBuilder.addGroup(groupId, groupTypeId);
		experimentBuilder.addGroupTypeId(groupTypeId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_GROUP_PROPERTY_VALUE);
	...
	public void testAddMaterialsProducerId() {
		...
		// precondition: if the materials producer id is null
		fillWithVariantGlobalProperties(experimentBuilder);
		experimentBuilder.addMaterialsProducerId(null, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_COMPONENT_IDENTIFIER);
	...
	public void testAddMaterialsProducerPropertyValue() {
		...
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_MATERIALS_PRODUCER_PROPERTY_ID);
		...
		experimentBuilder.defineMaterialsProducerProperty(materialsProducerPropertyId, propertyDefinition);
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_MATERIALS_PRODUCER_PROPERTY_ID);
		...
		experimentBuilder.defineMaterialsProducerProperty(materialsProducerPropertyId, propertyDefinition);
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_MATERIALS_PRODUCER_PROPERTY_VALUE);
	...
	public void testAddMaterialsProducerResourceLevel() {
		...
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		experimentBuilder.addResource(resourceId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_RESOURCE_ID);
		...
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		experimentBuilder.addResource(resourceId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_RESOURCE_ID);
		...
		experimentBuilder.addMaterialsProducerId(materialsProducerId, PlaceholderComponent.class);
		experimentBuilder.addResource(resourceId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NEGATIVE_RESOURCE_AMOUNT);
	...
	public void testAddPerson() {
		...
		experimentBuilder.addCompartmentId(compartmentId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_PERSON_ID);
		...
		experimentBuilder.addRegionId(regionId, PlaceholderComponent.class);
		experimentBuilder.addCompartmentId(compartmentId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_REGION_ID);

		// precondition: if the region id is unknown
		fillWithVariantGlobalProperties(experimentBuilder);
		experimentBuilder.addPerson(personId, regionId, compartmentId);
		experimentBuilder.addCompartmentId(compartmentId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_REGION_ID);
	...
	public void testAddPersonPropertyValue() {
		...
		experimentBuilder.addCompartmentId(compartmentId, PlaceholderComponent.class);
		experimentBuilder.addRegionId(regionId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_PERSON_ID);
		...
		experimentBuilder.addCompartmentId(compartmentId, PlaceholderComponent.class);
		experimentBuilder.addRegionId(regionId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_PERSON_PROPERTY_ID);
		...
		experimentBuilder.addCompartmentId(compartmentId, PlaceholderComponent.class);
		experimentBuilder.addRegionId(regionId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_PERSON_PROPERTY_ID);
		...
		experimentBuilder.addCompartmentId(compartmentId, PlaceholderComponent.class);
		experimentBuilder.addRegionId(regionId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_PERSON_PROPERTY_VALUE);
	...
	public void testAddRegionId() {
		...
		// precondition: if the region id is null
		fillWithVariantGlobalProperties(experimentBuilder);
		experimentBuilder.addRegionId(null, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_COMPONENT_IDENTIFIER);
	...
	public void testAddRegionPropertyValue() {
		...
		experimentBuilder.defineRegionProperty(regionPropertyId, propertyDefinition);
		experimentBuilder.addRegionId(regionId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_REGION_PROPERTY_ID);
		...
		experimentBuilder.defineRegionProperty(regionPropertyId, propertyDefinition);
		experimentBuilder.addRegionId(regionId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_REGION_PROPERTY_ID);
		...
		experimentBuilder.defineRegionProperty(regionPropertyId, propertyDefinition);
		experimentBuilder.addRegionId(regionId, PlaceholderComponent.class);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_REGION_PROPERTY_VALUE);
	...
	public void testAddResourcePropertyValue() {
		...
		experimentBuilder.defineResourceProperty(resourceId, resourcePropertyId, propertyDefinition);
		experimentBuilder.addResource(resourceId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_RESOURCE_PROPERTY_ID);

		// precondition: if the resource property id is unknown
		fillWithVariantGlobalProperties(experimentBuilder);
		experimentBuilder.addResourcePropertyValue(resourceId, TestResourceId.getUnknownResourcePropertyId(), propertyValue);
		experimentBuilder.defineResourceProperty(resourceId, resourcePropertyId, propertyDefinition);
		experimentBuilder.addResource(resourceId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.UNKNOWN_RESOURCE_PROPERTY_ID);
		...
		experimentBuilder.defineResourceProperty(resourceId, resourcePropertyId, propertyDefinition);
		experimentBuilder.addResource(resourceId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_RESOURCE_PROPERTY_VALUE);
	...
	public void testDefineBatchProperty() {
		...
		experimentBuilder.addMaterial(materialId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_BATCH_PROPERTY_DEFINITION);
	...
	public void testDefineCompartmentProperty() {
		...
		// precondition: if the compartment id is null
		fillWithVariantGlobalProperties(experimentBuilder);
		experimentBuilder.addCompartmentId(compartmentId, EmptyComponent.class);
		...
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_COMPARTMENT_PROPERTY_DEFINITION);
	...
	public void testDefineGlobalProperty() {
		...
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_GLOBAL_PROPERTY_DEFINITION);
	...
	public void testDefineGroupProperty() {
		...
		experimentBuilder.addGroupTypeId(groupTypeId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_GROUP_PROPERTY_DEFINITION);
	...
	public void testDefineMaterialsProducerProperty() {
		...
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_MATERIALS_PRODUCER_PROPERTY_DEFINITION);
	...
	public void testDefinePersonProperty() {
		...
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_PERSON_PROPERTY_DEFINITION);
	...
	public void testDefineRegionProperty() {
		...
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_REGION_PROPERTY_DEFINITION);
	...
	public void testDefineResourceProperty() {
		...
		ExperimentBuilder experimentBuilder = new ExperimentBuilder();
		ResourceId resourceId = TestResourceId.RESOURCE4;
		ResourcePropertyId resourcePropertyId = TestResourceId.RESOURCE4.getResourcePropertyIds()[0];
		PropertyDefinition propertyDefinition = PropertyDefinition	.builder()//
																	.setType(Long.class)//
		...
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_RESOURCE_PROPERTY_DEFINITION);
	...
	public void testSetPersonCompartmentArrivalTracking() {
		...
		for (TimeTrackingPolicy timeTrackingPolicy : TimeTrackingPolicy.values()) {
			...
			assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_COMPARTMENT_TRACKING_POLICY);
	...
	public void testSetPersonRegionArrivalTracking() {
		...
		for (TimeTrackingPolicy timeTrackingPolicy : TimeTrackingPolicy.values()) {
			...
			assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_REGION_TRACKING_POLICY);
	...
	public void testSetResourceTimeTracking() {
		...
		experimentBuilder.addResource(resourceId);
		assertScenarioException(() -> getScenarios(experimentBuilder.build()), ScenarioErrorType.NULL_RESOURCE_TRACKING_POLICY);
	...
	public void testCovaryBatchProperty() {
		...
		Object dimensionId = "DimensionId";
		BatchPropertyId batchPropertyId = TestMaterialId.MATERIAL_1.getBatchPropertyIds()[0];
		BatchPropertyId unknownPropertyId = TestMaterialId.getUnknownBatchPropertyId();
	...
	public void testCovaryGroupProperty() {
		...
		GroupId groupId = new GroupId(15);
		GroupPropertyId groupPropertyId = TestGroupTypeId.GROUP_TYPE_2.getGroupPropertyIds()[0];
		Object dimensionId = "DimensionId";
		GroupTypeId groupTypeId = TestGroupTypeId.GROUP_TYPE_2;
	...
	public void testCovaryPersonProperty() {
		...
		PersonPropertyId personPropertyId = TestPersonPropertyId.PERSON_PROPERTY_8;
		Object dimensionId = "DimensionId";
		RegionId regionId = TestRegionId.REGION_3;
	...
	public void testCovaryMaterialsProducerProperty() {
		...
		ExperimentBuilder experimentBuilder = new ExperimentBuilder();
		MaterialsProducerId materialsProducerId = TestMaterialsProducerId.MATERIALS_PRODUCER_3;
		MaterialsProducerPropertyId materialsProducerPropertyId = TestMaterialsProducerPropertyId.MATERIALS_PRODUCER_PROPERTY_4;
		Object dimensionId = "DimensionId";
	...
	public void testCovaryPersonResource() {
		...
		ResourceId personResourceId = TestResourceId.RESOURCE10;
		Object dimensionId = "DimensionId";
		RegionId regionId = TestRegionId.REGION_4;
		CompartmentId compartmentId = TestCompartmentId.COMPARTMENT_2;
	...
	public void testCovaryMaterialsProducerResource() {
		...
		ExperimentBuilder experimentBuilder = new ExperimentBuilder();
		MaterialsProducerId materialsProducerId = TestMaterialsProducerId.MATERIALS_PRODUCER_3;
		ResourceId materialsProducerResourceId = TestResourceId.RESOURCE2;
		Object dimensionId = "DimensionId";
	...
	public void testCovaryRegionResource() {
		...
		RegionId regionId = TestRegionId.REGION_3;
		ResourceId regionResourceId = TestResourceId.RESOURCE4;
		Object dimensionId = "DimensionId";
		CompartmentId compartmentId = TestCompartmentId.COMPARTMENT_5;
		CompartmentPropertyId compartmentPropertyId = TestCompartmentId.COMPARTMENT_5.getCompartmentPropertyId(0);
		PropertyDefinition compartmentPropertyDefinition = PropertyDefinition	.builder()//
	...
	private ExperimentBuilder getComplexScenaroFactory(long seed) {
		...
		for (TestCompartmentId testCompartmentId : TestCompartmentId.values()) {
			result.addCompartmentId(testCompartmentId, PlaceholderComponent.class);
		}
		for (TestCompartmentId testCompartmentId : TestCompartmentId.values()) {
	...
	public void testBuild() {
		...
		/*
		 * Show that the scenarios generated have scenario ids from 1 to the
		 * number of scenarios
		 */
		Set<ScenarioId> expectedScenarioIds = new LinkedHashSet<>();
		for (int i = 1; i <= scenarios.size(); i++) {
			expectedScenarioIds.add(new ScenarioId(i));
		}
