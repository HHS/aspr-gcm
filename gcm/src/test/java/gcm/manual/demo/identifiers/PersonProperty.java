...
public enum PersonProperty implements PersonPropertyId {
	...
	AGE(PropertyDefinition.builder().setType(Integer.class).setDefaultValue(0).build()),
	...
	IMMUNE(PropertyDefinition.builder().setType(Boolean.class).setDefaultValue(Boolean.FALSE).build()),
	SHADY(PropertyDefinition.builder().setType(Boolean.class).setDefaultValue(Boolean.FALSE).build()),
