...
public class AT_SphericalTriangle {
	...
	public void testConstructor() {
		...
		assertException(() -> new SphericalTriangle(null, sphericalPoint2, sphericalPoint3), MalformedSphericalTriangleException.class);

		assertException(() -> new SphericalTriangle(sphericalPoint1, null, sphericalPoint3), MalformedSphericalTriangleException.class);

		assertException(() -> new SphericalTriangle(sphericalPoint1, sphericalPoint2, null), MalformedSphericalTriangleException.class);
	}
